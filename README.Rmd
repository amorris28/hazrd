...
Alternatively, for a more convenient installation on a remote cluster, such as TSD, you can install from source using a tarball. Either download the latest `tar.gz` from the [releases](https://github.com/amorris28/hazrd/releases) page or clone the repo and then build a tar ball yourself:
